# si este no funciona, probar con el archivo main
...
class Ventana:
    ...
    def toggle_menu(self):
        if self.menu_visible:
            ...
            self.nuevo_frame.grid(row=1, column=0, padx=20, pady=20)

            # Crear botones en el nuevo frame
    ...
    def createMenuButtons(self):
        ...
        for i, texto in enumerate(botones_texto):
            ...
            boton.grid(row=i, column=0, padx=20, pady=10)  # Apilar los botones verticalmente

    def boton_click(self, i):
        # Acción a realizar al hacer clic en un botón
        print(f"Has hecho clic en: {['Carros', 'Camionetas', 'Motos', 'Carros Familiares'][i]}")
